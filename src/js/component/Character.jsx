...
export const Character = (props) => {
    ...
    const handleAddRemoveFav = () => {
      actions.addRemoveFav({ ...props.el, componentType: 'character' });
      setClicked(false);
    };
  ...
  return (
    <div className="card mx-3 col-4" style={{ width: "18rem" }}>
      <img
        ...
        src="https://imgix.ranker.com/list_img_v2/995/380995/original/380995-u2?fit=crop&fm=pjpg&q=60&dpr=2&w=1200&h=720"
        alt="Character"
      />
      ...
      <div className="d-flex justify-content-between p-2">
        <button
          ...
          onClick={() => navigate("/characterCard/" + props.el.uid)}
        >
          Learn More!
        </button>
        <button
